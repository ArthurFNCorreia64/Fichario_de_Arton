# Tormenta 20 - Ficha de Personagem Digital
...
* **Salvamento Automático (`localStorage`):** Os dados da sua ficha ficam salvos diretamente no navegador. Você pode fechar a aba e abrir no dia seguinte sem perder o progresso do seu herói.
